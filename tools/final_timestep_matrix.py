...
CASES_JSON = "/home/silver/ML-Reservoir-Simulation-Proxy-Exercise/xmgn/outputs/XMGN_2D_Q5SP_Waterflood/analysis/representative_cases.json"
TRUTH_BASE = "/home/silver/completed"
PRED_BASE  = "/home/silver/ML-Reservoir-Simulation-Proxy-Exercise/xmgn/outputs/XMGN_2D_Q5SP_Waterflood/inference/unrst"
OUT_PNG    = "/home/silver/ML-Reservoir-Simulation-Proxy-Exercise/xmgn/outputs/XMGN_2D_Q5SP_Waterflood/analysis/final_timestep_matrix.png"
...
def main():
    ...
    for case in cases:
        ...
        pred_unrst = os.path.join(PRED_BASE, f"{case}_PRED.UNRST")
