...
| `tools/` | Helper scripts: LHS case generator, Eclipse batch runner, dataset prep, graph inspector |
| `norne_base/` | The Norne reference deck (ODbL, Statoil/OPM) — text inputs only |
